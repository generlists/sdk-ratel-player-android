...
class IFramePlayerOptions private constructor(
    ...
    companion object {
        val default = Builder().controls(1).ccLoadPolicy(0).build()
    }

    override fun toString(): String = playerOptions.toString()

    internal fun getOrigin(): String = playerOptions.getString(Builder.ORIGIN)
    ...
    class Builder {
        ...
        fun build(): IFramePlayerOptions = IFramePlayerOptions(builderOptions)
        ...
        fun modestBranding(modestBranding: Int): Builder = this
