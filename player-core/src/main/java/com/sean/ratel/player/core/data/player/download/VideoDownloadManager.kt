...
class VideoDownloadManager
    ...
    constructor(
        ...
        fun startDownload(
            ...
            val request =
                DownloadRequest
                    .Builder(downloadId, downLoadUrl.toUri())
        ...
        /** 현재 다운로드 목록 */
        fun getCurrentDownloads(): List<Download> = downloadManager.currentDownloads

        /** 특정 다운로드 상태 조회 */
        fun find(downloadId: String): Download? = downloadManager.currentDownloads.firstOrNull { it.request.id == downloadId }
