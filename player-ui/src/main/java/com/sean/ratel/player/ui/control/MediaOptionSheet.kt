...
fun MediaOptionSheet(
    ...
    val playOptionItems = listOf(
        ...
        OptionItem(
            ...
            openLayer = openLayer.mapValues { (key, value) ->
    ...
    val screenOptionItems =  listOf(
        ...
        OptionItem(
            ...
            playerViewModel.getScreenCapture(onInfo = {
                info->
                run {
                    onInfo(info)
                }
        ...
        OptionItem(
            ...
            value = MediaOptionValue.Scale(mediaOptions.contentScale
            ),
        ...
        Box(Modifier
            ...
            Column(
                ...
                OptionSection(
                    ...
                    onChangeLayer = { b->
                        openLayer = openLayer +  (
                                MediaOptionKey.PLAYBACK_SPEED to b)

                        openLayer = openLayer +  (
                                MediaOptionKey.VIDEO_QUALITY to b)
                ...
                OptionSection(
                    ...
                    onChangeLayer = { b->
                        openLayer = openLayer +  (
                                MediaOptionKey.SCREEN_SCALE to b)
                    },
                    onSelect = {_, _,scale ->
