...
class ImageShareManager
    ...
    constructor() {
        fun shareChooser(
            ...
            val intent = baseImageShareIntent(context, uri, shareLauncher)
            val chooserIntent = Intent.createChooser(intent, context.getString(R.string.player_control_share))

            shareLauncher?.launch(chooserIntent)
                ?: context.startActivity(chooserIntent)
        }

        fun baseImageShareIntent(
            context: Context,
            uri: Uri,
            shareLauncher: ActivityResultLauncher<Intent>?,
        ): Intent =
        ...
        fun shareToLine(
            ...
            val intent =
                baseImageShareIntent(context, uri, shareLauncher).apply {
            ...
            try {
                ...
                shareChooser(context, uri, shareLauncher)
            }
        }
